          ...
          <div className="lg:w-32 pb-1 sm:pb-1 md:w-32 sm:w-28 w-28 flex justify-between items-center text-neutral-700 lg:text-2xl md:text-xl sm:text-base text-base">
            ...
            <Link to="/Handle">
              <div className="flex hover:scale-105 transition duration-200 ease-in-out">
                ...
                <div className="lg:text-[11px] lg:h-5 lg:w-5 lg:py-0.5 lg:-translate-y-3
                bg-rose-900 text-white rounded-full text-center lg:-translate-x-2
                md:h-4 md:w-4 md:-translate-x-1 md:-translate-y-3 md:py-0.5 md:text-[9px]
                sm:w-3 sm:h-3 sm:-translate-x-1 
                text-[7px] font-semibold h-3 w-3 inline -translate-x-1 -translate-y-2 cursor-pointer pt-[1px]">
                  <div className="lg:-translate-y-2
                  md:-translate-y-2.5 md:pt-[1px]
                  sm:-translate-y-2 sm:pt-[1px]
                  -translate-y-2 
