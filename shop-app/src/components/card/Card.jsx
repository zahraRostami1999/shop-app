...
<div
              ...
              className=" px-1 overflow-hidden shadow-gray-400 shadow-md border-zinc-200 border-2 lg:mx-5 mt-10 mx-3 rounded-2xl hover:border-zinc-300 hover:shadow-gray-900 hover:shadow-2xl transition duration-500 ease-in-out">
              <Link to={`/${id}`}>
                ...
                <div className="px-5 lg:px-3 md:px-3 break-words whitespace-normal ">
                  <h2 className="lg:h-28 flex flex-wrap md:h-32  text-zinc-800 text-sm lg:text-base md:text-sm font-Poppins pt-3 font-bold">
                    {title}
                  </h2>
