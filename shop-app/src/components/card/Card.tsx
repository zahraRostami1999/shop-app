      ...
      <>
         <div className="px-1 overflow-hidden lg:mx-5 mt-10 mx-3 rounded-md hover:border-zinc-300 hover:shadow-gray-900 hover:shadow-2xl transition duration-500 ease-in-out">
            ...
            <div className="px-5 lg:px-3 md:px-3 break-words whitespace-normal">
               <h2 className="lg:h-28 flex flex-wrap justify-center lg:items-start md:items-start sm:items-start items-center md:h-32 sm:h-36 h-28 text-zinc-800 text-xs sm:text-sm lg:text-base md:text-sm font-Poppins pt-3 lg:font-semibold md:font-semibold sm:font-medium font-medium text-center">
                  {title}
               </h2>
