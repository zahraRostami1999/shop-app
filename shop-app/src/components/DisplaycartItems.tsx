        ...
        <li key={matchingProduct.id} className="first:mt-20 flex flex-wrap justify-center items-center w-full border-2 shadow-lg lg:px-10 md:px-8 px-2 py-3 lg:mb-10 md:mb-8 mb-5 rounded-lg">
          ...
          <div className="grid grid-cols-5 lg:grid-cols-5 gap-4 w-full lg:w-10/12 md:w-11/12 mt-4 lg:mt-0">
            ...
            <div className="col-span-2 flex justify-center items-center h-10 rounded-3xl ">
                <div className="w-6" onClick={() => handleAdd(matchingProduct.id, matchingProduct.price)}><OrangeBtn><h1>+</h1></OrangeBtn></div>
                <div className="w-10 flex justify-center"><p className="text-sm font-semibold  text-left">{item.qty}</p></div>
                <div className="w-6" onClick={() => handleRemove(matchingProduct.id, item.qty, matchingProduct.title)}><GrayBtn><h1>-</h1></GrayBtn></div>
            </div>
