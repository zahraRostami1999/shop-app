   ...
   return (
      <>
         {loading ? (
            ...
            <div className=" w-full h-full flex flex-wrap justify-between lg:pt-16 md:pt-24 pt-16 min-h-screen">
               <div className=" w-full h-full">
                  ...
                  <img className="bg-cover w-full h-full mx-auto" src={cover} onLoad={() => setCoverLoaded(true)} style={{ display: coverLoaded ? "block" : "none" }} alt="Cover" />
               </div>
                  ...
                  <div className="flex justify-around">
                     <Link to="/Products">
                        <div className="border-2 bg-white rounded-lg lg:px-10 lg:py-10 hover:border-rose-900 transition-all duration-300">
                           {!imgLoaded1 && <div className="lg:w-40 lg:h-44 md:w-32 md:h-40 sm:w-28 sm:h-32 w-20 h-24" />}
                           <img
                     ...
                     <Link to="/Products">
                        <div
                           ...
                           style={{ display: coverLoaded ? "block" : "none" }}
                        >
                           {!imgLoaded2 && <div className="lg:w-40 lg:h-44 md:w-32 md:h-40 sm:w-28 sm:h-32 w-20 h-24" />}
                           <img className="lg:w-40 lg:h-44 md:w-32 md:h-40 sm:w-28 sm:h-32 w-20 h-24" src={Jewelery} alt="Jewelery" />
                           Jewelery
                        </div>
                     </Link>
                     <Link to="/Products">
                        <div
                           ...
                           style={{ display: coverLoaded ? "block" : "none" }}
                        >
                           {!imgLoaded3 && <div className="lg:w-40 lg:h-44 md:w-32 md:h-40 sm:w-28 sm:h-32 w-20 h-24" />}
                           <img className="lg:w-40 lg:h-44 md:w-32 md:h-40 sm:w-28 sm:h-32 w-20 h-24" src={Electronic} alt="Electronic" />
                           Electronics
                        </div>
                     </Link>
                  </div>
