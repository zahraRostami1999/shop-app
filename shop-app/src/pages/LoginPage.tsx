                  ...
                  <div className="lg:w-11/12 mx-auto md:w-11/12 sm:w-10/12 ">
                     ...
                     <div className="lg:mb-10 lg:mt-12 md:mt-14 ">
                        <input
                           ...
                           className="rounded border border-zinc-300  px-2 lg:h-12 md:h-10 sm:h-10 h-9 sm:text-sm text-sm required block w-5/6 my-5 md:my-5 mx-auto"
                           type="text"
                           placeholder="Username"
                        />
                        <input
                           onChange={(e) => setPassword(e.target.value)}
                           className="rounded border  mx-auto border-zinc-300  px-2 lg:h-12 md:h-10 sm:h-10 h-9 sm:text-sm text-sm required block w-5/6 my-5 md:my-5 "
                           type="password"
                     ...
                     <div className="block w-5/6 mx-auto">
                        ...
                        <div className="w-full flex justify-center">
                           <Button label="Login" size="large" onClick={verifyNewUser} />
                        </div>
                     </div>
                  </div>
               </div>
